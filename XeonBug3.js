...
const xtime = moment.tz('Asia/Kolkata').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Asia/Kolkata').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `ᴍᴀʟᴀᴍ ʙᴀɴɢ 🌌`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `ᴍᴀʟᴀᴍ ʙᴀɴɢ 🌃`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `sᴏʀᴇ ʙᴀɴɢ 🌃`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `sɪᴀɴɢ ʙᴀɴɢ 🌅`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `ᴘᴀɢɪ ʙᴀɴɢ 🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `ᴘᴀɢɪ ʙᴀɴɢ 🌄`
 } 
...
"body": `${ownername}`,
"previewType": "PHOTO",
"thumbnailUrl": "https://telegra.ph/file/c64bc9bb39783146ee7df.jpg",
...
list.push({
	...
	//chat counter (console log)
        if (m.message && m.isGroup) {
			...
			console.log(chalk.green(`│❑ 🛒 𝙶𝚁𝙾𝚄𝙿 𝙲𝙷𝙰𝚃 :`))
            console.log(chalk.white(chalk.bgRed('│❑ [ PESAN ]')), chalk.white(chalk.bgBlack(budy || m.mtype)) + '\n' + chalk.red('│❑ 🎉 𝙳𝙰𝚁𝙸'), chalk.yellow(m.sender) + '\n' + chalk.blueBright('│❑ => 𝙸𝙽'), chalk.green(groupName, m.chat))
            
console.log(chalk.cyan(`▣╾────────────────────┈`))
        } else {
            console.log(chalk.cyan(`\n▣╾────────────────────┈`))
			console.log(chalk.green(`│❑ 🌀 𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙲𝙷𝙰𝚃 :`))
            console.log(chalk.white(chalk.bgRed('|❑ [ PESAN ]')), chalk.white(chalk.bgBlack(budy || m.mtype)) + '\n' + chalk.magenta('|❑ 👀 𝙽𝚄𝙼𝙱𝙴𝚁'),chalk.yellow(m.sender))
  console.log(chalk.cyan(`▣╾────────────────────┈`))
        }
...
`.trim()
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://telegra.ph/file/c64bc9bb39783146ee7df.jpg-982.jpg',
                            sourceUrl: 'https://www.youtube.com/@Litzz445',
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                    }
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    text: `*Script Ori:* https://youtu.be/Geo3tWsceVI`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube @DGXeon And @Litzz445`,
                            thumbnailUrl: 'https://telegra.ph/file/c64bc9bb39783146ee7df.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
XeonBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, 𝙷𝙰𝙻𝙾 𝙺𝙰𝙺 𝙸𝙽𝙸 𝙰𝙳𝙰𝙻𝙰𝙷 𝙾𝚆𝙽𝙴𝚁𝙺𝚄 🛒`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
...
replygcxeon(`*sᴜᴄᴄᴇs ʙᴀɴɢ ʀᴇʏᴢ ʜᴀʀᴀᴘ ᴊᴇᴅᴀ 𝟹 ᴍᴇɴɪᴛᴀɴ ʏᴀ ᴀɢᴀʀ ʙᴏᴛ ᴛɪᴅᴀᴋ ᴛᴇʀʙᴀɴɴᴇᴅ ${xeongc}*`)
break
            case 'menu':
            case 'help':
            case 'alive':
            ...
            case 'reyz':
                let mono = '```'
                let xeonmenuoh = `${mono}ʜᴇʟʟᴏ ʙʀᴏ ${pushname} -  ${xeonytimewisher} 😵
${readmore}
...
┌
│ ◦ .ᴍᴇɴᴜ *ᴍᴇɴᴜ
│ ◦ .ʙᴜʏᴘʀᴇᴍɪᴜᴍ *ᴀᴅᴅᴀᴄᴄᴇss ʙᴜɢ*
│ ◦ .ʀᴜɴᴛɪᴍᴇ *ʙᴏᴛ ᴛɪᴍᴇ*
│ ◦ .sᴄʀɪᴘᴛ *sᴄʀɪᴘᴛ ʙᴏᴛ ʙᴜɢ*
│ ◦ .ᴅᴏɴᴀᴛᴇ *ᴛʜᴀɴᴋ ʏᴏᴜ*
│ ◦ .ᴏᴡɴᴇʀ *ᴄʀᴇᴀᴛᴏʀ ʙᴏᴛ*
└
...
│ ◦ .sᴛɪᴄᴋᴇʀ *ʀᴇᴘʟʏ ɪᴍᴀɢᴇ*
│ ◦ .ǫᴄ *ᴛᴇxᴛ*
│ ◦ .sᴍᴇᴍᴇ *ʀᴇᴘʟʏ ɪᴍᴀɢᴇ + ᴛᴇxᴛ*
│ ◦ .ᴛᴀᴋᴇ *ᴛᴇxᴛ*
│ ◦ .ᴛᴏɪᴍᴀɢᴇ *ʀᴇᴘʟʏ sᴛɪᴄᴋᴇʀ*
│ ◦ .ᴛᴏᴠɪᴅᴇᴏ *ʀᴇᴘʟʏ sᴛɪᴄᴋᴇʀ*
│ ◦ .ᴛᴏᴀᴜᴅɪᴏ *ʀᴇᴘʟʏ ᴠɪᴅᴇᴏ/ᴠᴏɪᴄᴇ*
│ ◦ .ᴛᴏᴍᴘ𝟹 *ʀᴇᴘʟʏ ᴠɪᴅᴇᴏ/ᴠᴏɪᴄᴇ*
│ ◦ .ᴛᴏᴠɴ *ʀᴇᴘʟʏ ᴠɪᴅᴇᴏ/ᴀᴜᴅɪᴏ*
│ ◦ .ᴛᴏɢɪғ *ʀᴇᴘʟʏ ɪᴍᴀɢᴇ/ᴠɪᴅᴇᴏ*
│ ◦ .ᴛᴏᴜʀʟ *ʀᴇᴘʟʏ ɪᴍᴀɢᴇ/ᴠɪᴅᴇᴏ*
│ ◦ .ᴛᴏǫʀ *ᴛᴇxᴛ*
│ ◦ .ᴛᴏᴠɪᴇᴡᴏɴᴄᴇ *ʀᴇᴘʟʏ ɪᴍᴀɢᴇ/ᴠɪᴅᴇᴏ*
│ ◦ .ғʟɪᴘᴛᴇxᴛ *ᴛᴇxᴛ*
│ ◦ .ᴇᴍᴏᴊɪᴍɪx *🤕+🥳*
└
...
│ ◦ .sᴏᴜɴᴅ𝟷 - sᴏᴜɴᴅ𝟷𝟼𝟷
└
*ʙᴏᴛ ʙᴜɢ sᴇᴇ ᴡʜᴀᴛsᴀᴘᴘ ᴏʀɪ/ʙɪsɴɪs* ${mono}`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
